...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        trimmedArmorItem(ModItems.TANGERINE_LEGGINGS);
        trimmedArmorItem(ModItems.TANGERINE_BOOTS);

        simpleItem(ModItems.ESSENCE_T1);
        simpleItem(ModItems.ESSENCE_T2);
        simpleItem(ModItems.ESSENCE_T3);
        simpleItem(ModItems.ESSENCE_T4);
        simpleItem(ModItems.ESSENCE_T5);
        simpleItem(ModItems.ESSENCE_T6);
        simpleItem(ModItems.ESSENCE_T7);
    }
