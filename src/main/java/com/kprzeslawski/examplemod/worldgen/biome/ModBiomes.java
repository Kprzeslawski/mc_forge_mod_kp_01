package com.kprzeslawski.examplemod.worldgen.biome;
...
public class ModBiomes {
    public static final ResourceKey<Biome> TEST_BIOME = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(ExampleMod.MOD_ID, "test_biome"));
    ...
    public static Biome testBiome(BootstapContext<Biome> context) {
        ...
        spawnBuilder.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(ModEntities.EN_ZOMBIE_L1.get(), 2, 3, 5));
        spawnBuilder.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(ModEntities.EN_ZOMBIE_L3.get(), 2, 3, 5));
        spawnBuilder.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(ModEntities.EN_ZOMBIE_L4.get(), 2, 3, 5));
